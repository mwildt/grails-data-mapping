...
class CriteriaBuilderAdapter extends GroovyObjectSupport implements BuildableCriteria, ProjectionList {
    ...
    protected List<Query.Junction> logicalExpressionStack = new ArrayList<Query.Junction>();
    protected MetaObjectProtocol queryMetaClass;
    protected  Query.ProjectionList projectionList;
    protected PersistentEntity persistentEntity;
    protected boolean readOnly;

    public CriteriaBuilderAdapter(final Class targetClass, final Session session) {
    ...
    public CriteriaBuilderAdapter(final Class targetClass, final Session session, final Query query) {
    ...
    protected boolean isCriteriaConstructionMethod(String name, Object[] args) {
    ...
    protected void handleJunction(Query.Junction junction, Closure callable) {
